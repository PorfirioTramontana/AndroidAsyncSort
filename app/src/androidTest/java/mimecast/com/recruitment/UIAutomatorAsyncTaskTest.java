...
public class UIAutomatorAsyncTaskTest {
    ...
    private static final String BASIC_SAMPLE_PACKAGE = "mimecast.com.recruitment";
    ...
    @Test
    public void Test1Fast() throws InterruptedException, UiObjectNotFoundException, RemoteException {
        int time=FAST;
